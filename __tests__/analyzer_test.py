...
df_raw = LasLoader('../__rawdata__/Seahawk_231015_231341_00_D.las').load_to_dataframe()
df_target = LasLoader('../__testdata__/Seahawk_231015_231341_00_D.las').load_to_dataframe()
